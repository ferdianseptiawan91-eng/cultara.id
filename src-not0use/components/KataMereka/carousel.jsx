  ...
  return (
    <div className="relative w-full max-w-[729px] mx-auto">
      ...
      <div className="flex items-center gap-4 mt-4 overflow-hidden">
        ...
        <button
          onClick={prevSlide}
          className="bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-full transition-all duration-300 cursor-pointer border border-white/20 hover:scale-110 text-gray-700 hover:text-gray-900"
...
export default KataMerekaCarousel;